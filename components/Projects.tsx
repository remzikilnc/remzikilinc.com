                            ...
                            <div className="flex-row flex mb-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-[10px]">
                                        A Game Price Comparator App designed to offer an efficient solution for
                        ...
                        >
                            <div className="flex-row flex mb-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-[10px]">
                                        The e-commerce project. Also features that AI-based filtering capabilities like
                                        including user name and user comment filtering.
                                    </p>
                                </div>
                            </div>
                        </Link>
